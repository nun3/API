...
Given(`que cliquei no botão Novo no cabeçalho de filtro`, cy.clickNewButton);
When(`clico no botão Novo no cabeçalho de filtro`, cy.clickNewButton);

Given(`que cliquei no botão Filtrar no cabeçalho de filtro`, cy.clickFilterButton);
When(`que clico no botão Filtrar no cabeçalho de filtro`, cy.clickFilterButton);
